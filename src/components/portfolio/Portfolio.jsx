      ...
      <div className="container portfolio-container">
        <article className="portfolio-item">
          <div className="portfolio-item-image">
            <img id='proj-img' src={Movies} alt="Watched movies Image" />
          </div>
          <h3 className='heading'>Watched Movie Counter</h3>
          <div className="cta">
          <a className='btn' target='_blank' href="https://github.com/slemekoana/watched-movie-counter">GitHub</a>
          <a className='btn primary-btn' target='_blank' href="https://watched-movie-counter.netlify.app/">Live Demo</a>
          </div>
        </article>
        <article className="portfolio-item">
          <div className="portfolio-item-image">
            <img id='proj-img' src={FiBytes} alt="FiBytes Image" />
          </div>
          <h3 className='heading'>FiBytes by SheBytes</h3>
          <div className="cta">
